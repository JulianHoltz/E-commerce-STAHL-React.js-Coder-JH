...
export const Item = ({product}) => {
  ...
  return (
    <div className='max-w-64 flex flex-col justify-center border-solid border-4 border-slate-300 rounded-2xl items-center p-4 bg-slate-100'>
      ...
      <button className='bg-slate-900 text-slate-100 max-w-sm border-solid border-2 rounded-2xl items-center p-4 bg-slate-100 hover:bg-slate-500'><Link to={`/item/${product.id}`}>Ver Mas</Link></button>
